...
class admin_set extends admin {
	...
	public function doregsetsave(){
		global $_M;
		$configlist = array();
		$configlist[] = 'gz_member_register';
		$configlist[] = 'gz_member_vecan';
		$configlist[] = 'gz_member_bgcolor';
		$configlist[] = 'gz_member_force';
		$configlist[] = 'gz_member_bgimage';
	...
	public function doopensave(){
		global $_M;
		$configlist = array();
		$configlist[] = 'gz_weixin_appid';
		$configlist[] = 'gz_weixin_appsecret';
		$configlist[] = 'gz_weixin_gz_appid';
		$configlist[] = 'gz_weixin_gz_appsecret';
		$configlist[] = 'gz_weibo_appkey';
		$configlist[] = 'gz_weibo_appsecret';
		$configlist[] = 'gz_qq_appid';
		$configlist[] = 'gz_qq_appsecret';
		$configlist[] = 'gz_weixin_open';
		$configlist[] = 'gz_weibo_open';
		$configlist[] = 'gz_qq_open';
		configsave($configlist);
	...
	public function doemailsetsave(){
		global $_M;
		$configlist = array();
		$configlist[] = 'gz_member_email_reg_title';
		$configlist[] = 'gz_member_email_reg_content';
		
		$configlist[] = 'gz_member_email_password_title';
		$configlist[] = 'gz_member_email_password_content';
			
		$configlist[] = 'gz_member_email_safety_title';
		$configlist[] = 'gz_member_email_safety_content';
