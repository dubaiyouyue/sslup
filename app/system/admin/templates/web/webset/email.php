...
<div class="v52fmbx">
	...
	<dl>
		...
		<dd class="ftype_input">
			<div class="fbox">
				<input name="gz_fd_fromname" type="text" autocomplete="off" value="{$_M[config][gz_fd_fromname]}" />
			</div>
	...
	<dl>
		...
		<dd class="ftype_input">
			<div class="fbox">
				<input name="gz_fd_usename" type="text" autocomplete="off" value="{$_M[config][gz_fd_usename]}" />
			</div>
	...
	<dl>
		...
		<dd class="ftype_input">
			<div class="fbox">
				<input name="gz_fd_password" type="password" autocomplete="off" value="passwordhidden" />
			</div>
	...
	<dl>
		...
		<dd class="ftype_input">
			<div class="fbox">
				<input name="gz_fd_smtp" type="text" autocomplete="off" value="{$_M[config][gz_fd_smtp]}" />
			</div>
	...
	<dl class="morodllist" style="display:none;">
		...
		<dd class="ftype_input">
			<div class="fbox">
				<input name="gz_fd_port" type="text" autocomplete="off" value="{$_M[config][gz_fd_port]}" />
			</div>
	...
	<dl class="morodllist" style="display:none;">
		...
		<dd class="ftype_radio">
			<div class="fbox">
				<label><input type="radio" name="gz_fd_way" value="ssl" data-checked="{$_M[config][gz_fd_way]}" />{$_M[word][ssl]}</label>
				<label><input type="radio" name="gz_fd_way" value="tls" />{$_M[word][tls]}</label>
			</div>
