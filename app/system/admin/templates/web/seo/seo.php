...
<div class="v52fmbx">
	...
	<dl>
		...
		<dd class="ftype_input">
			<div class="fbox">
				<input name="gz_hometitle" type="text" value="{$_M[config][gz_hometitle]}" />
			</div>
	...
	<dl>
		...
		<dd class="ftype_radio">
			<div class="fbox">
				<label><input type="radio" name="gz_title_type" value="0" data-checked="{$_M[config][gz_title_type]}" />{$_M[word][setseotitletype1]}</label>
				<label><input type="radio" name="gz_title_type" value="1" />{$_M[word][setseotitletype3]}</label>
				<label><input type="radio" name="gz_title_type" value="2" />{$_M[word][setseotitletype2]}</label>
				<label><input type="radio" name="gz_title_type" value="3" />{$_M[word][setseotitletype4]}</label>
			</div>
	...
	<dl>
		...
		<dd class="ftype_input">
			<div class="fbox">
				<input name="gz_alt" type="text" value="{$_M[config][gz_alt]}" />
			</div>
	...
	<dl>
		...
		<dd class="ftype_input">
			<div class="fbox">
				<input name="gz_atitle" type="text" value="{$_M[config][gz_atitle]}" />
			</div>
	...
	<dl>
		...
		<dd class="ftype_input">
			<div class="fbox">
				<input name="gz_linkname" type="text" value="{$_M[config][gz_linkname]}" />
			</div>
	...
	<dl>
		...
		<dd class="ftype_ckeditor">
			<div class="fbox">
				<textarea name="gz_foottext" data-ckeditor-type="1">{$_M['config']['gz_foottext']}</textarea>
			</div>
		</dd>
	</dl>
	<dl>
		...
		<dd class="ftype_ckeditor">
			<div class="fbox">
				<textarea name="gz_seo" data-ckeditor-type="1">{$_M['config']['gz_seo']}</textarea>
			</div>
		</dd>
	</dl>
	<dl class="noborder">
