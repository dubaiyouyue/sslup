...
<div class="v52fmbx">
	...
	<dl>
		...
		<dd class="ftype_radio">
			<div class="fbox">
				<label><input type="radio" name="gz_pseudo" value="1" data-checked="{$_M[config][gz_pseudo]}" />{$_M[word][open]}</label>
				<label><input type="radio" name="gz_pseudo" value="0" />{$_M[word][close]}</label>
			</div>
