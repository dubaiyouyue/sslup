...
if(isset($metadmin['productother'])){
	$_M['config']['gz_productTabok'] = $metadmin['productother']+1;
}
if($metinfover == 'v1' || $metadmin['productother']){
	$tems[productother]    = $_M['config']['gz_productTabok']-1;
	$tems['productTabname']    = $_M['config']['gz_productTabname'];
	$tems['productTabname_1']  = $_M['config']['gz_productTabname_1'];
	$tems['productTabname_2']  = $_M['config']['gz_productTabname_2'];
	$tems['productTabname_3']  = $_M['config']['gz_productTabname_3'];
	$tems['productTabname_4']  = $_M['config']['gz_productTabname_4'];
}
