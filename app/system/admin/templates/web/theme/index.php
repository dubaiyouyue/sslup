...
<input type="hidden" name="gz_skin_user" value="{$_M[config][gz_skin_user]}" />
...
$qy = $_M['config']['gz_skin_user']==$val['skin_file']?'1':'0';
$qytxt = $_M['config']['gz_skin_user']==$val['skin_file']?$_M['word']['skinused']:$_M['word']['skinusenow'];
echo <<<EOT
-->
...
-->
			<div class="theme-right-erweima">
				<dl>
					...
					<dd class="erweima" data-size="{$_M[config][wap_dimensional_size]}" data-logo="{$_M[config][gz_dimensional_logo]}">{$_M['word']['trying_load']}...</dd>
					<dd>
					<br/>
