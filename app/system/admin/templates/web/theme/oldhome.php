...
-->
	<dl>
		...
		<dd class="ftype_select">
			<div class="fbox">
				<select name="gz_flash_10001_imgtype" data-checked="{$inbaset[3]}">
...
echo <<<EOT
-->
				<input type="text" name="gz_flash_10001_x" value="{$inbaset[1]}" style="width:40px;">
				×
<!--
EOT;
}
echo <<<EOT
-->
				<input type="text" name="gz_flash_10001_y" value="{$inbaset[2]}" style="width:40px;">
...
-->
	...
	<dl>
		<dd class="ftype_ckeditor_theme">
			<div class="fbox">
				<textarea name="gz_index_content" data-ckeditor-type="2" data-ckeditor-y="380">{$_M['config']['gz_index_content']}</textarea>
			</div>
		</dd>
	</dl>
<!--
