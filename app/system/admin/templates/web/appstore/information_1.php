...
<form method="POST" class="ui-from" name="myform" action="{$_M['url']['app_api']}a=domember_modify&user_id={$_M['form']['user_id']}&user_pass={$_M['form']['user_pass']}&return_type=jump&admin_url={$_M['url']['site_admin']}&user_pass_old={$_M['form']['user_pass_old']}&user_key={$_M['config']['gz_secret_key']}" target="_self">
