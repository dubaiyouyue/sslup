...
<div class="v52fmbx">
	...
	<table class="display dataTable ui-table" data-table-ajaxurl="{$_M['url']['app_api']}a=dotable_temlist_json&info_id={$result['columnid']}&stat_key={$result['value']}&lang={$_M['lang']}&user_key={$_M['config']['gz_secret_key']}" data-table-pagelength="20" data-table-datatype="jsonp" data-applist="app1001|app1003">
		<thead>
