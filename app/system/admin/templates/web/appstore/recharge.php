...
<input id="ordernum" type="hidden" value="{$_M['config']['gz_secret_key']}">
<input id="payjumphref" type="hidden" value="{$sucurl}">
	<div class="v52fmbx">
		<div class="paydiv">
		<form method="POST" class="ui-from" name="myform" action="{$_M['url']['api']}n=platform&c=pay&a=doalipay&user_key={$_M['config']['gz_secret_key']}" target="_blank">
