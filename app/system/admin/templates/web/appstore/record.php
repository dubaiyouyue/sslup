...
<form method="POST" name="myform" class="ui-from" action="" target="_self">
	<div class="v52fmbx">
<table class="display dataTable ui-table" data-table-datatype="jsonp" data-table-ajaxurl="{$_M['url']['app_api']}a=dotable_record_json&search_type={$_M['form']['search_type']}&search_title={$_M['form']['search_title']}&user_key={$_M['config']['gz_secret_key']}">
    <thead>
        <tr>
