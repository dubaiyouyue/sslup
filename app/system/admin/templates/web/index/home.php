...
<div class="index_box">
	<section class="index_point hidden-xs">
		<h3>{$_M['word']['new_guidelines']}<a href="http://edu.resonance.com.cn/" target="_blank" {$gz_agents_display}>{$_M['word']['extension_school']}<i class="fa fa-angle-right"></i></a></h3>
		...
		<ul>
			...
			<li>
				<div class="bdsharebuttonbox" 
					data-bdUrl="{$_M[config][gz_weburl]}" 
					data-bdText="{$_M['word']['sys_use']} MetInfo {$_M['word']['build_site']} {$_M[config][gz_weburl]} {$_M['word']['everyone_see']}" 
...
<!--
EOT;
if(($privilege['navigation'] == 'metinfo' || strstr($privilege['navigation'], '1507')) && $_M['config']['gz_agents_app']) {
echo <<<EOT
-->
...
-->
	<section class="index_news">
		<h3>MetInfo {$_M['word']['upfiletips37']}<a href="http://www.resonance.com.cn/" target="_blank">{$_M['word']['columnmore']}<i class="fa fa-angle-right"></i></a></h3>
		<div id="newslist" data-newslisturl="http://www.resonance.com.cn/metv5news.php?fromurl={$_M[config][gz_weburl]}&action=json&listnum=6">
		</div>
	</section>
<!--
EOT;
