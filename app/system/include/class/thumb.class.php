...
class thumb {
	...
	public function list_news() {
		global $_M;
		$this->set('thumb_width', $_M['config']['gz_newsimg_x']);
		$this->set('thumb_height', $_M['config']['gz_newsimg_y']);
		$this->set('thumb_save_type', 1);
		$this->set('thumb_savepath', 'thumb/');
		$this->set('thumb_kind', $_M['config']['gz_thumb_kind']);
	...
	public function list_product() {
		global $_M;
		$this->set('thumb_width', $_M['config']['gz_productimg_x']);
		$this->set('thumb_height', $_M['config']['gz_productimg_y']);
		$this->set('thumb_save_type', 1);
		$this->set('thumb_savepath', 'thumb/');
		$this->set('thumb_kind', $_M['config']['gz_thumb_kind']);
		$this->set('thumb_bgcolor', '#FFFFFF');
	...
	public function list_img() {
		global $_M;
		$this->set('thumb_width', $_M['config']['gz_imgs_x']);
		$this->set('thumb_height', $_M['config']['gz_imgs_y']);
		$this->set('thumb_save_type', 1);	
		$this->set('thumb_savepath', 'thumb/');
		$this->set('thumb_kind', $_M['config']['gz_thumb_kind']);
		$this->set('thumb_bgcolor', '#FFFFFF');
	...
	public function contents_img() {
		global $_M;
		$this->set('thumb_width', $_M['config']['gz_imgdetail_x']);
		$this->set('thumb_height', $_M['config']['gz_imgdetail_y']);
		$this->set('thumb_save_type', 1);	
	...
	public function contents_product() {
		global $_M;
		$this->set('thumb_width', $_M['config']['gz_productdetail_x']);
		$this->set('thumb_height', $_M['config']['gz_productdetail_y']);
		$this->set('thumb_kind', $_M['config']['gz_thumb_kind']);
		$this->set('thumb_save_type', 1);
		$this->set('thumb_savepath', 'thumb_dis/');
		$this->set('thumb_bgcolor', '#FFFFFF');
