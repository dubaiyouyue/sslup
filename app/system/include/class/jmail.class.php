...
class jmail{
	...
	public function set_sys_mailbox() {
		global $_M;		
		$this->set_send_mailbox($_M['config']['gz_fd_usename'], $_M['config']['gz_fd_fromname'], $_M['config']['gz_fd_usename'], $_M['config']['gz_fd_password'], $_M['config']['gz_fd_smtp'], $_M['config']['gz_fd_port'], $_M['config']['gz_fd_way']);
	}
