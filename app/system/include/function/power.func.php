 ...
 * 例：get_gz_cookie('metinfo_admin_name'):返回当前管理员的账号
	   get_gz_cookie('metinfo_member_name'):返回当前会员的账号
	   get_gz_cookie('metinfo_admin_pass'):返回当前管理员的密码
	   get_gz_cookie('metinfo_member_pass'):返回当前会员的密码
 */
