...
class userweb extends web {
	...
	public function __construct() {
		...
		if($_M['config']['gz_title_type'] == 0){
			$_M['tem_data']['title'] = $member['name'];
		}else if($_M['config']['gz_title_type'] == 1){
			$_M['tem_data']['title'] = $member['name'].'-'.$_M['config']['gz_keywords'];
		}else if($_M['config']['gz_title_type'] == 2){
			$_M['tem_data']['title'] = $member['name'].'-'.$_M['config']['gz_webname'];
		}else if($_M['config']['gz_title_type'] == 3){
			$_M['tem_data']['title'] = $member['name'].'-'.$_M['config']['gz_keywords'].'-'.$_M['config']['gz_webname'];
		}
