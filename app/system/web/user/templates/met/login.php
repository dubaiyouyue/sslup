...
<!--
EOT;
if($_M['config']['gz_qq_open']||$_M['config']['gz_weixin_open']||$_M['config']['gz_weibo_open']){
echo <<<EOT
-->
...
if($_M['config']['gz_weixin_open'] && !(!is_weixin_client() && is_mobile_client())){
echo <<<EOT
-->
...
<!--
EOT;
if($_M['config']['gz_member_register']){
echo <<<EOT
-->
